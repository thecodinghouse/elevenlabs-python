...
class TextToSpeechClient:
    ...
    def convert(
        ...
        *,
        ...
        model_id : typing.Optional[str]
            Identifier of the model that will be used, a vocoder that synthesizes the audio. The model needs to have support for text to speech, you can check this using the can_do_text_to_speech property.
        ...
        -------
        typing.Tuple[bytes, typing.Optional[str]]
            A tuple containing the audio data as bytes and the request ID.
        ...
        with self._raw_client.convert(
            ...
            return b"".join(r.data), r.headers.get("request-id")
    ...
    def convert_with_timestamps(
        ...
        *,
        ...
        return _response.data, _response.headers.get("request-id")
